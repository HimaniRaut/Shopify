# 🛍️ Shopify - Modern E-commerce Platform
...
Shopify is a modern, full-stack e-commerce platform built with Next.js 14, TypeScript, and MongoDB. It features a beautiful UI with Tailwind CSS, secure authentication, real-time cart updates, and a seamless shopping experience.
...
Shopify follows a three-tier architecture pattern:
...
```bash
git clone https://github.com/HimaniRaut/Shopify.git
cd terraform
```
2. **Generate SSH Key Pair:**
Create a new SSH key to access your EC2 instance:
```bash
ssh-keygen -f Shopify-key
```
This will prompt you to create a new key file named Shopify-key.

3. **Private key permission:** Change your private key permission:
```bash
chmod 400 Shopify-key
```
...
```bash
ssh -i Shopify-key ubuntu@<public-ip>
```
...
```bash
aws eks --region ap-south-1 update-kubeconfig --name Shopif-eks-cluster
```
...
> > In **General**<br/>
> > - **Description:** Shopify<br/>
> > - **Check the box:** `GitHub project`<br/>
> > - **GitHub Repo URL:** `https://github.com/<your user-name/Shopify`<br/>
>
> > In **Trigger**<br/>
...
> > - **SCM:** `Git`<br/>
> > - **Repository URL:** `https://github.com/<your user-name/Shopify`<br/>
...
```bash
aws eks update-kubeconfig --region eu-west-1 --name Shopify-eks-cluster
```
